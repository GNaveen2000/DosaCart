...
export default function About()
{
    return (
        ...
        <div class="d-flex flex-column justify-content-between h-100 p-3 p-md-4 p-xl-5">
          <h3 class="m-0"><b id="welcome">Welcome</b> to Sree Venkata Sai Durga Pickels!</h3>
...
{/* <p class="mb-0">Not a member yet? <Link to="/Register">Register</Link><a href="http://localhost:3000/Register" class="link-secondary text-decoration-none">Register now</a></p>
